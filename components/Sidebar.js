...
const navItems = [
  ...
  { href: "/predictions/crypto", label: "Crypto", icon: "bitcoin" },
  { href: "/predictions/stocks", label: "Stocks", icon: "trending" },
  { href: "/predictions/startups", label: "Startups", icon: "rocket" },
  { href: "/predictions/political", label: "Political", icon: "landmark" },
  { href: "/predictions/casino", label: "Casino", icon: "dice" },
  { href: "/backtesting", label: "Backtesting", icon: "rewind" },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-dark-800 border-r border-dark-600 flex flex-col z-50">
      ...
      <div className="p-6 border-b border-dark-600">
        ...
        <p className="text-xs text-gray-500 mt-1 tracking-widest uppercase">Prediction Engine</p>
      </div>
      ...
      <div className="p-4 border-t border-dark-600">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-400">5 Active Predictions</span>
        </div>
